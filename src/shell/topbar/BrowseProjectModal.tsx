...
export function BrowseProjectModal({
  ...
  return (
    <Overlay
      ...
      labelledBy="browse-modal-title"
      stageClassName="drawer-stage--modal"
      surfaceClassName="drawer--modal modal-card browse-modal-card"
      surfaceRef={browseDialogRef as React.MutableRefObject<HTMLDivElement | null>}
    >
